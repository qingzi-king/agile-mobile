...
import { Result, Icon, Button, Toast } from '../../index';
import '../style/index.less';

const Demo = () => {

  const handleRefresh = () => {
    Toast.info({ content: '已触发更新事件！', duration: 500 });
  }
      ...
      <section className="d-demo-content">
        ...
        <div className="d-demo-block">
          <Result
            ...
            expandNode={<Button type="default" dashed size="small" style={{marginTop:5}} icon="refresh-o" onClick={handleRefresh}>立即刷新</Button>}
          />
        </div>
