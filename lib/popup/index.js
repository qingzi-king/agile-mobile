...
var Popup = function Popup(props) {
  ...
  var wrapCls = (0, _classnames.default)(prefixCls, className, (_a = {}, _a[prefixCls + "-top"] = position === 'top', _a[prefixCls + "-right"] = position === 'right', _a[prefixCls + "-bottom"] = position === 'bottom', _a[prefixCls + "-left"] = position === 'left', _a));
  var kids = React.Children.map(children, insertSpace);
  divs.push(div);
  maskDivs.push(maskDiv);
  ReactDOM.render( /*#__PURE__*/React.createElement("div", (0, _extends2.default)({
    className: wrapCls
  }, restProps), /*#__PURE__*/React.createElement("div", {
    className: "fam-popup-warp"
  }, closable && /*#__PURE__*/React.createElement(_index.Icon, {
    type: "cross",
